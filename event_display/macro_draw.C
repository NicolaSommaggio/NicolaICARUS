...
void macro_draw(/*int run, int evt, int plane=2*/){

//const std::string fdata = "/pnfs/icarus/persistent/users/cfarnese/MC_overlays_2026_3/group_6664.flat.caf.root";

//const std::string fdata = "/pnfs/icarus/persistent/users/cfarnese/cafs_MPV_MPR_Nicola/*.root";

//const std::string fdata = "/pnfs/icarus/persistent/users/cfarnese/MC_overlays_2026_1/*.root";
...
//const std::string fdata = "/pnfs/icarus/scratch/users/cfarnese/9435_Feb06_2026/*.root";
...
//const std::string fdata = "/pnfs/sbn/data/sbn_fd/poms_production/data/Reproc_Run2_SBN/reconstructed/icaruscode_v10_06_00_01p05/offbeambnbmajority/flatcaf_unblind/68/48/compressed_data_dl10_fstrmOffBeamBNBMAJORITY_run10054_2_20250905T211255_bnbext_20250905T222731-stage1.Unblind.DONOTLOOK.flat.caf-03a27da7-7768-486a-bc97-48528a928da4.root";
...
while(std::getline(events,line))
{
    ...
    int reco_class;
    std::string filename;
    ss >> run >> evt >> nslice >> reco_class >> filename;
    runList.push_back(run);
    evtList.push_back(evt);
    sliceList.push_back(nslice);

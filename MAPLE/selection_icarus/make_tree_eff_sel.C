...
//  TFile fout("/exp/sbnd/data/users/marterop/sel_dirt/selected_icarus_standard_eff_sel_MC_tmatch05_dirt_nocrt.root", "RECREATE");
  ...
  //TFile fout("sbruce_trees/SBRUCE_TREE_MAPLE_NICOLA_RUN4_MU_L_50_PRO_KE_50_CHI2_VAR_TRACKSCORE_VAR_VISIBLE_VAR_CRTveto_NOLmu_FV_Trigger_offbeam.root", "RECREATE");
  ...
  //TFile fout("sbruce_trees/SBRUCE_TREE_MAPLE_NICOLA_RUN4_MU_L_40_PRO_KE_40_CHI2_VAR_TRACKSCORE_VAR_VISIBLE_VAR_CRTveto_Lmu_FV_offbeam.root", "RECREATE");
  ...
  TFile fout("sbruce_trees/SBRUCE_TREE_MAPLE_NICOLA_RUN4_MU_L_40_PRO_KE_40_CHI2_VAR_TRACKSCORE_VAR_VISIBLE_VAR_offbeam.root", "RECREATE");

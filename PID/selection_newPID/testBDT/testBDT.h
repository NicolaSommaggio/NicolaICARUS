...
//BDT
std::string path_BDT_model = "GBDT_small_stat_newTS_multiplane_newvars.txt";
...
ofstream dump_mu_length("dump_mu_length.txt");
ofstream dump_selected_mu_length("dump_selected_mu_length.txt");
ofstream dump_pro_length("dump_pro_length.txt");
ofstream dump_selected_pro_length("dump_selected_pro_length.txt");
ofstream dump_pi_length("dump_pi_length.txt");
ofstream dump_selected_pi_length("dump_selected_pi_length.txt");
...
const SpillMultiVar testBDT([](const caf::SRSpillProxy* sr)-> std::vector<double>
{
    ...
    for(const auto &islc : sr->slc)
    {
        ...
        for (std::size_t ipfp(0); ipfp < islc.reco.npfp; ++ipfp)
        {
            ...
            dump_purity << islc.reco.pfp[ipfp].trk.truth.p.pdg << " " << islc.reco.pfp[ipfp].trk.len << " " << Ek << " " << prediction << endl;
            ...
            if(std::abs(islc.reco.pfp[ipfp].trk.truth.p.pdg) == 13)
            {
              ...
              if(prediction == 0 || prediction == 1){dump_selected_mu_length << islc.reco.pfp[ipfp].trk.len << endl;}
            }
            if(std::abs(islc.reco.pfp[ipfp].trk.truth.p.pdg) == 2212)
            {
              dump_pro_length << islc.reco.pfp[ipfp].trk.len << " " << Ek_proton << endl;    

              if(prediction == 2 || prediction == 3){dump_selected_pro_length << islc.reco.pfp[ipfp].trk.len << " " << Ek_proton << endl;}
            }
            if(std::abs(islc.reco.pfp[ipfp].trk.truth.p.pdg) == 211)
            {
              dump_pi_length << islc.reco.pfp[ipfp].trk.len << " " << Ek_pion << endl;    

              if(prediction == 4 || prediction == 5){dump_selected_pi_length << islc.reco.pfp[ipfp].trk.len << " " << Ek_pion << endl;}
            }

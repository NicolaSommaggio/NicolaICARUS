...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal(static_cast<::reco_track*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::reco_track*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal(static_cast<::true_track*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::true_track*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal(static_cast<::RecoSlice*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::RecoSlice*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   static void delete_reco_track(void *p) {
      delete (static_cast<::reco_track*>(p));
   }
   static void deleteArray_reco_track(void *p) {
      delete [] (static_cast<::reco_track*>(p));
   }
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_true_track(void *p) {
      delete (static_cast<::true_track*>(p));
   }
   static void deleteArray_true_track(void *p) {
      delete [] (static_cast<::true_track*>(p));
   }
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_RecoSlice(void *p) {
      delete (static_cast<::RecoSlice*>(p));
   }
   static void deleteArray_RecoSlice(void *p) {
      delete [] (static_cast<::RecoSlice*>(p));
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<true_track>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<true_track>", -2, "vector", 423,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<true_track>","std::vector<true_track, std::allocator<true_track> >"));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const vector<true_track>*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEtrue_trackgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const vector<true_track>*>(nullptr))->GetClass();
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_vectorlEtrue_trackgR(void *p) {
      delete (static_cast<vector<true_track>*>(p));
   }
   static void deleteArray_vectorlEtrue_trackgR(void *p) {
      delete [] (static_cast<vector<true_track>*>(p));
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<track>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<track>", -2, "vector", 423,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<reco_track>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<reco_track>", -2, "vector", 423,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<reco_track>","std::vector<reco_track, std::allocator<reco_track> >"));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const vector<reco_track>*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEreco_trackgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const vector<reco_track>*>(nullptr))->GetClass();
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_vectorlEreco_trackgR(void *p) {
      delete (static_cast<vector<reco_track>*>(p));
   }
   static void deleteArray_vectorlEreco_trackgR(void *p) {
      delete [] (static_cast<vector<reco_track>*>(p));
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<RecoSlice>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<RecoSlice>", -2, "vector", 423,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<RecoSlice>","std::vector<RecoSlice, std::allocator<RecoSlice> >"));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const vector<RecoSlice>*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlERecoSlicegR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const vector<RecoSlice>*>(nullptr))->GetClass();
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_vectorlERecoSlicegR(void *p) {
      delete (static_cast<vector<RecoSlice>*>(p));
   }
   static void deleteArray_vectorlERecoSlicegR(void *p) {
      delete [] (static_cast<vector<RecoSlice>*>(p));
   }
...
"/exp/icarus/app/users/nsommagg/NicolaICARUS/PID/selection_newPID/",
nullptr
    };

...
#define R__DICTIONARY_FILENAME daughtersDict
...
namespace ROOT {
   static TClass *daughtersInfo_Dictionary();
   static void daughtersInfo_TClassManip(TClass*);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::daughtersInfo*)
   {
      ...
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::daughtersInfo));
      static ::ROOT::TGenericClassInfo 
         instance("daughtersInfo", "daughtersInfo.h", 6,
                  typeid(::daughtersInfo), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &daughtersInfo_Dictionary, isa_proxy, 4,
   ...
   static TClass *daughtersInfo_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::daughtersInfo*)nullptr)->GetClass();
      daughtersInfo_TClassManip(theClass);
   return theClass;
   }
...
namespace {
  void TriggerDictionaryInitialization_daughtersDict_Impl() {
...
#line 1 "daughtersDict dictionary forward declarations' payload"
...
struct __attribute__((annotate("$clingAutoload$daughtersInfo.h")))  daughtersInfo;
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "daughtersDict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("daughtersDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_daughtersDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_daughtersDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_daughtersDict() {
  TriggerDictionaryInitialization_daughtersDict_Impl();
}
